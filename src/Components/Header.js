        ...
        <nav className={`${isOpen && "open"} lg:block`}>
          <div>
            ...
            <ul className="flex flex-col text-center mt-10 lg:mt-0 lg:text-left lg:flex-row lg:items-center lg:gap-6">
              ...
              <li className="border-t border-slate-400 py-4 lg:border-transparent lg:py-0">
                <button className=" lg:bg-red-400 text-white py-2 px-4 rounded shadow-lg hover:opacity-75 lg:text-xs uppercase tracking-widest border-2 lg:border-red-400 lg:hover:bg-transparent lg:hover:text-slate-800 transition-all duration-200 w-full">
                  Login
                </button>
              </li>
            </ul>
